...
createShop("Zeke's Superior Scimitar", CoinCurrency()) {
    items[0] = ShopItem(Items.BRONZE_SCIMITAR, 5, 32, 17, 1, 100)
    items[1] = ShopItem(Items.IRON_SCIMITAR, 3, 112, 61, 1, 200)
    items[2] = ShopItem(Items.STEEL_SCIMITAR, 2, 400, 220, 1, 600)
