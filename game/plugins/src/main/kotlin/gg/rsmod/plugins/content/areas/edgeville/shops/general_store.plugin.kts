...
createShop("Edgeville General Store", CoinCurrency()) {
    ...
    items[11] = ShopItem(Items.KNIFE, 1, 7, 2, 1, 2)
    items[12] = ShopItem(Items.NEWCOMER_MAP, 5, 1, 0, 1, 100)
    items[13] = ShopItem(Items.SECURITY_BOOK, 5, 2, 0, 1, 100)
}